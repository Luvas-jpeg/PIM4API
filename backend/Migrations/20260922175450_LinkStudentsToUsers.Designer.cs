...
namespace backend.Migrations
{
    ...
    [Migration("20260922175450_LinkStudentsToUsers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EquipamentosMedicosApi.Models.AuditLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EquipamentosMedicosApi.Models.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EquipamentosMedicosApi.Models.CourseAssessment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EquipamentosMedicosApi.Models.CourseAssessmentAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CourseAssessmentAnswers");
                });

            modelBuilder.Entity("EquipamentosMedicosApi.Models.CourseAssessmentAttempt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UserId", "AssessmentId", "AttemptNumber")
                        .IsUnique();

                    b.ToTable("CourseAssessmentAttempts");
                });

            modelBuilder.Entity("EquipamentosMedicosApi.Models.CourseCertificate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EquipamentosMedicosApi.Models.CourseLesson", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EquipamentosMedicosApi.Models.CourseModule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EquipamentosMedicosApi.Models.CourseProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EquipamentosMedicosApi.Models.CourseQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EquipamentosMedicosApi.Models.CourseQuestionOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EquipamentosMedicosApi.Models.PaymentWebhookEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EquipamentosMedicosApi.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EquipamentosMedicosApi.Models.AuditLog", b =>
                {
                    b.HasOne("EquipamentosMedicosApi.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("EquipamentosMedicosApi.Models.Course", b =>
                {
                    b.HasOne("EquipamentosMedicosApi.Models.Product", "LegacyProduct")
                        .WithMany()
                        .HasForeignKey("LegacyProductId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("LegacyProduct");
                });

            modelBuilder.Entity("EquipamentosMedicosApi.Models.CourseAssessment", b =>
                {
                    b.HasOne("EquipamentosMedicosApi.Models.Course", "Course")
            ...
            modelBuilder.Entity("EquipamentosMedicosApi.Models.CourseAssessmentAnswer", b =>
                {
                    b.HasOne("EquipamentosMedicosApi.Models.CourseAssessmentAttempt", "Attempt")
                        .WithMany("Answers")
                        .HasForeignKey("AttemptId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EquipamentosMedicosApi.Models.CourseQuestion", "Question")
                        .WithMany()
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EquipamentosMedicosApi.Models.CourseQuestionOption", "SelectedOption")
                        .WithMany()
            ...
            modelBuilder.Entity("EquipamentosMedicosApi.Models.CourseAssessmentAttempt", b =>
                {
                    b.HasOne("EquipamentosMedicosApi.Models.CourseAssessment", "Assessment")
                        .WithMany()
            ...
            modelBuilder.Entity("EquipamentosMedicosApi.Models.CourseLesson", b =>
                {
                    b.HasOne("EquipamentosMedicosApi.Models.CourseModule", "Module")
                        .WithMany("Lessons")
